# tithonium/docker-minecraft-server

My personal build setup for a minecraft server docker image. Derived from [itzg's](https://github.com/itzg/dockerfiles/tree/master/minecraft-server), but with tweaks and adjustments to suit my own taste. Mainly, I wanted something I would work from as a base so I could build multi-arch images.

I'm including itzg's [README](https://github.com/itzg/dockerfiles/blob/master/minecraft-server/README.md) here, with relevant parts removed/edited:

*******************************************************************************************
*******************************************************************************************


[![Docker Pulls](https://img.shields.io/docker/pulls/tithonium/minecraft-server.svg)](https://hub.docker.com/r/itzg/minecraft-server/)
